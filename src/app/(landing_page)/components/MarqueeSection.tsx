  ...
  const testimonials = [
    {
      ...
      message: "NutriSmart telah membantu saya mengontrol diabetes saya dengan mengatur porsi makanan yang tepat. Berat badan saya turun 5kg dalam 3 bulan!",
      imgSrc: "https://randomuser.me/api/portraits/men/1.jpg"
    },
    {
      name: "Siti Rahayu",
      role: "Nutrisionis",
      message: "Sebagai ahli gizi, saya sangat merekomendasikan NutriSmart kepada klien saya. Teknologi QR pada piring ini sangat inovatif.",
    ...
    },
    {
      ...
      message: "NutriSmart membantu saya memahami porsi makanan yang tepat. Tekanan darah saya sekarang terkontrol dengan baik.",
      imgSrc: "https://randomuser.me/api/portraits/women/4.jpg"
    },
    {
      name: "Denny Prakoso",
      role: "Atlet",
      message: "Sebagai atlet, nutrisi sangat penting. NutriSmart memudahkan saya melacak asupan kalori dan nutrisi untuk performa optimal.",

          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <Image 
                ...
                className="mr-2"
              />
              <span className="font-bold text-xl text-black">NutriSmart</span>
            </div>
            ...
            <div className="flex space-x-3">
              ...
              <a href="https://instagram.com/NutriSmartid" className="bg-primary rounded-full p-2 text-white hover:opacity-80 transition-opacity">
                <Instagram size={18} />
              </a>
              <a href="https://facebook.com/NutriSmartid" className="bg-primary rounded-full p-2 text-white hover:opacity-80 transition-opacity">
                <Facebook size={18} />
              </a>
              <a href="https://youtube.com/@NutriSmartid" className="bg-primary rounded-full p-2 text-white hover:opacity-80 transition-opacity">
                <Youtube size={18} />
              </a>
            </div>
        ...
        <div className="mt-12 pt-6 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-black">
              &copy; {new Date().getFullYear()} NutriSmart. All rights reserved.
            </p>

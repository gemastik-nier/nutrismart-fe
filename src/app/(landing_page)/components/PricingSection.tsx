...
export function PricingSection() {
  ...
  const ecommerceLinks = {
    shopee: "https://shopee.com/NutriSmart"
  };
      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-black mb-4">
            NutriSmart <span className="text-primary">SMART PLATE</span>
          </h2>
          ...
          <p className="text-lg text-gray-600">
            Beli NutriSmart sekarang dan dapatkan <span className="font-bold text-primary">AKSES PREMIUM GRATIS</span> selama periode early bird!
          </p>
        </div>

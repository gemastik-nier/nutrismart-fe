          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600">
                NutriSmart membantu Anda mengontrol porsi makan dengan tepat melalui pembagian area makanan yang dirancang khusus dan teknologi QR code yang inovatif.
              </p>
            </div>

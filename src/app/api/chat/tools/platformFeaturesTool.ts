...
export const platformFeaturesTool = tool({
  description: 'Memberikan informasi tentang fitur-fitur platform digital NutriSmart (food scanning, nutrition tracking, AI assistant, resep, info kesehatan, layanan tambahan)',
  parameters: z.object({

...
export const metadata: Metadata = {
  title: 'Ketentuan Layanan | NutriSmart',
  description: 'Baca Ketentuan Layanan untuk NutriSmart.',
};
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 outfit-font">
      <div className="max-w-3xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        <header className="mb-10 text-center">
          <Link href="/">
            <img src="/assets/img/logo.png" alt="Logo NutriSmart" className="w-24 h-auto mx-auto mb-4" />
          </Link>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Selamat datang di NutriSmart! Ketentuan Layanan ini ("Ketentuan") mengatur penggunaan Anda atas situs web, aplikasi seluler,
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-2">
            NutriSmart menyediakan platform untuk pelacakan nutrisi, analisis makanan melalui pemindaian makanan, informasi kesehatan yang dipersonalisasi,
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            Dengan menggunakan Layanan kami, Anda setuju bahwa NutriSmart dapat menggunakan data Anda sesuai dengan Kebijakan Privasi kami.
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            dan akan tetap menjadi milik eksklusif NutriSmart dan pemberi lisensinya. Merek dagang dan tampilan dagang kami tidak boleh
            digunakan sehubungan dengan produk atau layanan apa pun tanpa persetujuan tertulis sebelumnya dari NutriSmart.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            atau non-pelanggaran. NutriSmart tidak menjamin bahwa Layanan akan tidak terganggu, aman, atau bebas dari kesalahan.
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dalam keadaan apa pun NutriSmart, maupun direktur, karyawan, mitra, agen, pemasok, atau afiliasinya,
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">
            Jika Anda memiliki pertanyaan tentang Ketentuan ini, silakan hubungi kami di NutriSmartugm@gmail.com
          </p>
        </section>

        <footer className="mt-12 pt-8 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-500">&copy; {currentYear} NutriSmart. Semua hak dilindungi.</p>
        </footer>
      </div>
    </div>
  );

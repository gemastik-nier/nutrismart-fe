...
export const metadata: Metadata = {
  title: 'Kebijakan Privasi | NutriSmart',
  description: 'Baca Kebijakan Privasi untuk NutriSmart.',
};
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            NutriSmart ("kami") berkomitmen untuk melindungi privasi Anda. Kebijakan Privasi ini menjelaskan bagaimana kami
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Jika Anda memiliki pertanyaan atau komentar tentang Kebijakan Privasi ini, silakan hubungi kami di: NutriSmartugm@gmail.com
          </p>
        </section>
